    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      var LANG = {        ru: {
          ...
          scOracleWho: 'Оракул', scIntroTitle: 'Спроси о себе', scIntroSubtitle: 'Оракул отвечает по твоей карте, а не общими словами. Один вопрос — одна Искра.',
        ...
        en: {
          ...
          scOracleWho: 'Oracle', scIntroTitle: 'Ask about yourself', scIntroSubtitle: 'The Oracle answers from your chart, not in generalities. One question — one Spark.',
        ...
        de: {
          ...
          scOracleWho: 'Orakel', scIntroTitle: 'Frag nach dir selbst', scIntroSubtitle: 'Das Orakel antwortet aus deiner Karte, nicht mit Allgemeinplätzen. Eine Frage — ein Funke.',
        ...
        fr: {
          ...
          scOracleWho: 'Oracle', scIntroTitle: 'Interroge-toi', scIntroSubtitle: 'L’Oracle répond d’après ta carte, pas en généralités. Une question — une Étincelle.',
