    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      var LANG = {        ru: {
          ...
          scOracleWho: 'Оракул', scIntroTitle: 'Поговорим о тебе', scIntroSubtitle: 'Отношения, деньги, решение, которое всё откладываешь. Отвечаю по твоей дате рождения, лично тебе. Один вопрос — одна Искра.',
        ...
        en: {
          ...
          successEtaLabel: 'In progress', successEtaTime: '10–15 minutes', successHelpT: 'Silence for over 20 minutes?', successHelpBody: 'Message the bot “song didn’t arrive” — we’ll sort it out and refund Iskry if something broke.', successGoPlaylist: 'Open Playlist', successShareShort: 'Share', successOrderSubCard: 'Paid by card', successOrderSubStars: 'Paid with Stars', successOrderSubIskry: 'Paid with Iskry', successOrderSubPromo: 'Paid with a promo code', // CD 19.09 · оплата прошла
          ...
          cfTitlePay: 'Package payment', cfPayWith: 'Pay with', cfNote: 'One-time payment for 30 days · no auto-renewal', payWaitSheet: 'Waiting for payment confirmation…', tuWhy1: 'Iskry never expire — you pay only when you buy', tuWhy2: 'Spend them on songs, Oracle questions and gifts', tuFootNote: '+{n} Iskry = {songs} songs · one-time payment, Iskry never expire', tuPerSong: '{p} ₽/song', // CD 19.09 · пакет и пополнение
          payFootNote: 'Charged once · your song arrives in 10–15 minutes', payWaitCta: 'Waiting for payment…', payWaitNote: 'Keep this screen open', payFailCta: 'Choose another method', payFailNote: 'You have not been charged', payIskrySub: '{n} Iskry · you have {bal}', bsTopupIskrySub: 'A song costs {n} Iskry', // CD 19.09 · оплата песни
          ...
          pfArchSub: 'A reading by your birth date', pfPackLabel: 'Pack', pfChangePack: 'Change', pfNoPack: 'No pack — songs one at a time or with Iskry', pfOfSongs: 'of {n} {songs}', pfIskrySub: 'Enough for {n} {songs}', pfTopup: 'Top up', profileCardNoCard: 'No card linked', pfPartnerRow: 'Partner dashboard', pfPartnerSub: 'Invitees, commission and payouts', pfMine: 'Mine', pfMyTracks: 'My tracks', pfSettings: 'Settings', pfLang: 'Language', pfNotify: 'Notifications', pfCommunity: 'Community', pfHelpSupport: 'Help & support', pfRestore: 'Restore purchases', pfRestoreDone: 'Purchases restored', pfRestoreFail: 'No purchases to restore', // CD 19.09 · профиль
          ...
          scOracleWho: 'Oracle', scIntroTitle: 'Let’s talk about you', scIntroSubtitle: 'Relationships, money, the decision you keep putting off. I answer from your birth date, for you alone. One question — one Spark.',
        ...
        de: {
          ...
          successEtaLabel: 'Wird erstellt', successEtaTime: '10–15 Minuten', successHelpT: 'Länger als 20 Minuten Stille?', successHelpBody: 'Schreib dem Bot „Song nicht angekommen“ — wir klären es und erstatten Iskry, falls etwas schiefging.', successGoPlaylist: 'Playlist öffnen', successShareShort: 'Teilen', successOrderSubCard: 'Mit Karte bezahlt', successOrderSubStars: 'Mit Stars bezahlt', successOrderSubIskry: 'Mit Iskry bezahlt', successOrderSubPromo: 'Mit Gutscheincode bezahlt', // CD 19.09 · оплата прошла
          ...
          cfTitlePay: 'Paket bezahlen', cfPayWith: 'Womit du zahlst', cfNote: 'Einmalzahlung für 30 Tage · keine automatische Abbuchung', payWaitSheet: 'Warten auf Zahlungsbestätigung…', tuWhy1: 'Iskry verfallen nie — du zahlst nur beim Kauf', tuWhy2: 'Für Songs, Orakel-Fragen und Geschenke', tuFootNote: '+{n} Iskry = {songs} Songs · Einmalzahlung, Iskry verfallen nie', tuPerSong: '{p} ₽/Song', // CD 19.09 · пакет и пополнение
          payFootNote: 'Einmalige Zahlung · dein Song kommt in 10–15 Minuten', payWaitCta: 'Warten auf Zahlung…', payWaitNote: 'Bildschirm nicht schließen', payFailCta: 'Andere Zahlungsart wählen', payFailNote: 'Es wurde nichts abgebucht', payIskrySub: '{n} Iskry · du hast {bal}', bsTopupIskrySub: 'Ein Song kostet {n} Iskry', // CD 19.09 · оплата песни
          ...
          scOracleWho: 'Orakel', scIntroTitle: 'Reden wir über dich', scIntroSubtitle: 'Beziehungen, Geld, die Entscheidung, die du immer aufschiebst. Ich antworte aus deinem Geburtsdatum, ganz persönlich. Eine Frage — ein Funke.',
        ...
        fr: {
          ...
          successEtaLabel: 'En cours', successEtaTime: '10–15 minutes', successHelpT: 'Silence depuis plus de 20 minutes ?', successHelpBody: 'Écris au bot « la chanson n’est pas arrivée » — on règle ça et on rembourse les Iskry si quelque chose a cassé.', successGoPlaylist: 'Ouvrir la playlist', successShareShort: 'Partager', successOrderSubCard: 'Payé par carte', successOrderSubStars: 'Payé en Stars', successOrderSubIskry: 'Payé en Iskry', successOrderSubPromo: 'Payé avec un code promo', // CD 19.09 · оплата прошла
          ...
          cfTitlePay: 'Paiement du pack', cfPayWith: 'Moyen de paiement', cfNote: 'Paiement unique pour 30 jours · sans prélèvement automatique', payWaitSheet: 'En attente de confirmation du paiement…', tuWhy1: 'Les Iskry n’expirent pas — tu ne paies que lorsque tu achètes', tuWhy2: 'Pour des chansons, des questions à l’Oracle et des cadeaux', tuFootNote: '+{n} Iskry = {songs} chansons · paiement unique, les Iskry n’expirent pas', tuPerSong: '{p} ₽/chanson', // CD 19.09 · пакет и пополнение
          payFootNote: 'Débité une fois · ta chanson arrive dans 10–15 minutes', payWaitCta: 'Paiement en cours…', payWaitNote: 'Ne ferme pas l’écran', payFailCta: 'Choisir un autre moyen', payFailNote: 'Rien n’a été débité', payIskrySub: '{n} Iskry · tu en as {bal}', bsTopupIskrySub: 'Une chanson coûte {n} Iskry', // CD 19.09 · оплата песни
          ...
          pfArchSub: 'Une lecture d’après ta date de naissance', pfPackLabel: 'Forfait', pfChangePack: 'Changer', pfNoPack: 'Pas de forfait — chansons à l’unité ou avec des Iskry', pfOfSongs: 'sur {n} {songs}', pfIskrySub: 'Assez pour {n} {songs}', pfTopup: 'Recharger', profileCardNoCard: 'Aucune carte liée', pfPartnerRow: 'Espace partenaire', pfPartnerSub: 'Invités, commission et paiements', pfMine: 'À moi', pfMyTracks: 'Mes chansons', pfSettings: 'Réglages', pfLang: 'Langue', pfNotify: 'Notifications', pfCommunity: 'Communauté', pfHelpSupport: 'Aide et support', pfRestore: 'Restaurer les achats', pfRestoreDone: 'Achats restaurés', pfRestoreFail: 'Aucun achat à restaurer', // CD 19.09 · профиль
          ...
          scOracleWho: 'Oracle', scIntroTitle: 'Parlons de toi', scIntroSubtitle: 'Les relations, l’argent, la décision que tu repousses sans cesse. Je réponds d’après ta date de naissance, rien que pour toi. Une question — une Étincelle.',
